<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="EDIManagement.index" %>
...
<head>
    ...
    <link href="assets/libs/jqwidgets/styles/jqx.base.css" rel="stylesheet" />
    <link href="assets/libs/jqwidgets/styles/jqx.metro.css" rel="stylesheet" />
...
<body class="hold-transition skin-blue sidebar-mini">
                ...
                <div class="row">
                    <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-aqua">
                            ...
                            <a href="orders.aspx" class="small-box-footer">Ver mas <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-green">
                            <div class="inner">
                                <h3><span id="OINPROCESS">0</span></h3>
    ...
    <script src="assets/libs/jqwidgets/jqx-all.js"></script>
